...
def _build_full_analytics_response(
    ...
    *,
    ...
    return AnalyticsResponse(
        ...
        account_control_blocking_issue_count=account_control_blocking_issue_count,
    ...
    if not positions:
        ...
        return response.model_copy(
            update={
                ...
                "household_totals_trusted": effective_totals.household_totals_trusted,
                "account_control_status": effective_totals.account_control_status,
                "account_control_summary": effective_totals.account_control_summary,
                "account_control_blocking_issue_count": effective_totals.account_control_blocking_issue_count,
