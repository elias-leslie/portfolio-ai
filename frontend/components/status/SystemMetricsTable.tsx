  ...
  const metrics = [
    {
      ...
      percent: resources.disk.percentUsed,
      status: resources.disk.status,
      usage: `${resources.disk.usedGb.toFixed(1)} GB`,
      total: `${resources.disk.totalGb.toFixed(1)} GB`,
    },
    {
      id: "memory",
      name: "Memory",
      icon: <MemoryStick className="h-4 w-4 text-purple-500" />,
      percent: resources.memory.percentUsed,
      status: resources.memory.status,
      usage: `${resources.memory.usedGb.toFixed(1)} GB`,
      total: `${resources.memory.totalGb.toFixed(1)} GB`,
    },
    {
      id: "cpu",
      name: "CPU",
      icon: <Cpu className="h-4 w-4 text-orange-500" />,
      percent: resources.cpu.percentUsed,
      status: resources.cpu.status,
      usage: `${resources.cpu.cores} cores`,
      total: null,
    },
    {
      id: "db_pool",
      ...
      percent: resources.databasePool.percentUsed,
      status: resources.databasePool.status,
      usage: `${resources.databasePool.checkedOut} active`,
      total: `${resources.databasePool.poolSize} pool`,
      overflow: resources.databasePool.overflow,
    },
  ];
