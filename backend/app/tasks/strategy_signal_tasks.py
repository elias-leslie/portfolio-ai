...
@celery_app.task(name="app.tasks.strategy_signal_tasks.generate_daily_strategy_signals")  # type: ignore[misc]
...
@celery_app.task(name="app.tasks.strategy_signal_tasks.generate_signal_for_strategy_task")  # type: ignore[misc]
