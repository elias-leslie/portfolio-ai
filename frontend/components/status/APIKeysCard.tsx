...
import type { APIKeyStatusInfo } from '@/lib/api/status'
    ...
    >
      ...
      <div className="mt-4 p-3 bg-muted/50 rounded-lg text-xs text-muted-foreground">
        ...
        <p>
          ...
          &quot;Not Configured&quot; will not be used for data fetching. Set the
          environment variable and restart services to activate a source.
        </p>
      </div>
    </ExpandableCard>
  )
