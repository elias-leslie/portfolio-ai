        ...
        <div className="space-y-4">
            ...
            {newsHidden && (
                <Card
                    ...
                    data-testid="watchlist-news-hidden-card"
                >
                    <CardHeader className="pb-3">
                        <CardTitle className="text-base">
                            News &amp; Sentiment
                    ...
                    <CardContent>
                        <p
                            ...
                            data-testid="watchlist-news-hidden"
                        >
                            News headlines are hidden by your watchlist
                            preferences. Enable the toggle in Settings →
                            Watchlist to view sentiment-scored articles here.
                        </p>
                    </CardContent>
                </Card>
            )}
            ...
            {!newsHidden && (newsSummary || newsArticles.length > 0) && (
                <Card
                    className="border-border"
                    data-testid="watchlist-news-card"
                >
                    <CardHeader className="pb-3">
                        <CardTitle className="text-base">
                            News &amp; Sentiment
                                    ...
                                    <div>
                                        ...
                                        {fallbackCoverage > 0 && (
                                            <p className="text-xs text-text-muted">
                                                {fallbackCoverage} headline
                                                {fallbackCoverage === 1
                                                    ? ""
                                                    : "s"}{" "}
                                                scored with fallback model
                                            </p>
                                        )}
                                    </div>
                                </div>
                        ...
                        {newsArticles.length > 0 && (
                            <div className="space-y-2">
                                ...
                                {newsArticles.length > maxNewsArticles && (
                                    <p className="text-xs text-text-muted">
                                        Showing {maxNewsArticles} of{" "}
                                        {newsArticles.length} headlines
                                    </p>
                                )}
                            </div>
                        )}
