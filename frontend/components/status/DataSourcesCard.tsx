    ...
    >
      {!sourceEntries.length ? (
        <p className="text-sm text-muted-foreground">
          No data sources configured. Add vendors in your configuration to begin
...
function getStatusBadge(status: string) {
  switch (status) {
    case 'ok':
      return (
        <Badge className="bg-status-success text-text-inverted">Healthy</Badge>
      )
    case 'degraded':
      return (
        <Badge className="bg-status-warning text-text-inverted">Degraded</Badge>
      )
    case 'down':
