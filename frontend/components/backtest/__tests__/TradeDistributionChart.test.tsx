...
describe('TradeDistributionChart', () => {
  ...
  it('calculates correct average win', () => {
    const trades = [{ pnlPct: 10.0 }, { pnlPct: 20.0 }, { pnlPct: -5.0 }]
  ...
  it('calculates correct average loss', () => {
    const trades = [{ pnlPct: 10.0 }, { pnlPct: -4.0 }, { pnlPct: -6.0 }]
  ...
  it('handles string pnlPct values', () => {
    const trades = [{ pnlPct: '5.5' }, { pnlPct: '-3.2' }]
  ...
  it('filters out null pnlPct values', () => {
    const trades = [{ pnlPct: 10.0 }, { pnlPct: null }, { pnlPct: -5.0 }]
  ...
  it('displays color legend', () => {
    ...
    expect(screen.getByText(/Green bars = winning trades/)).toBeInTheDocument()
  })
})
