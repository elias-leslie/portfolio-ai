...
- [ ] 0.2 Review findings and identify reusable patterns
...
- [ ] 0.3 Checkpoint: Confirm architecture approach
...
- [ ] 1.1 Create Paper Trading API endpoints
...
- [ ] 1.2 Create Backtesting API endpoints
...
- [ ] 1.3 Fix stuck backtests (all in "running" status)
...
- [ ] 1.4 Fix stale price data in idea_outcomes
...
- [ ] 1.5 Create TypeScript types for all endpoints
...
- [ ] 2.2 Create summary cards section
...
- [ ] 2.3 Create positions table (Open tab)
...
- [ ] 2.4 Create expandable row details
...
- [ ] 2.5 Create closed trades table (Closed tab)
...
- [ ] 2.6 Create hooks for data fetching
...
- [ ] 2.7 Add loading and error states
...
- [ ] 3.3 Create run details main area
...
- [ ] 3.6 Create hooks for data fetching
...
- [ ] 3.7 Add loading and error states
...
- [ ] 4.1 Create Paper Trading summary card
...
- [ ] 4.2 Create Backtesting summary card
...
- [ ] 4.3 Add both cards to dashboard
  - [ ] Update /app/page.tsx
...
- [ ] 5.1 Add action buttons to watchlist expandable rows
