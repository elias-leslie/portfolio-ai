      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 ml-6 space-y-3">
            ...
            {/* Trend Indicator */}
            {reading.scoreChange !== undefined &&
              reading.scoreChange !== null && (
        ...
        <div className="pt-2 border-t border-border">
          <p className="text-sm text-muted-foreground">
            {reading.score >= 75 &&
              'Market sentiment is extremely bullish. Watch for potential reversal.'}
            {reading.score >= 55 &&
              reading.score < 75 &&
              'Market sentiment is optimistic. Greed is building.'}
            {reading.score >= 45 &&
              reading.score < 55 &&
              'Market sentiment is balanced. No clear trend.'}
            {reading.score >= 25 &&
              reading.score < 45 &&
              'Market sentiment is cautious. Fear is present.'}
            {reading.score < 25 &&
              'Market sentiment is extremely bearish. Potential buying opportunity.'}
          </p>
        </div>
      </div>
    </Card>
