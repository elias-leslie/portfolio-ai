// Portfolio AI Service Worker
// Provides offline caching and PWA support

const CACHE_NAME = 'portfolio-ai-v2';
const STATIC_CACHE_NAME = 'portfolio-ai-static-v2';
...
self.addEventListener('activate', (event) => {
  event.waitUntil(
    caches.keys().then((cacheNames) => {
      return Promise.all(
        cacheNames
          .filter((name) => name.startsWith('portfolio-ai-') && name !== CACHE_NAME && name !== STATIC_CACHE_NAME)
