...
1. **2.5 — affordability panel**: surface 1.4's Free to spend on the review
   screen itself, where the month's verdict is.
2. **2.6 — phase-aware retirement block** (D13), then **2.7** — retire the
   Decision Board's four cards, the allocation donut (→ Investing) and the
