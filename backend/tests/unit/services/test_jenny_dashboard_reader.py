...
def test_get_latest_symbol_review_uses_newest_routine_for_symbol() -> None:
    ...
    rows = [
        ("eval-new-1", "routine-new", "NVDA", "equity-analyst", None, None, "review", 0.6, "fresh thesis", None, [], [], {}, None, None, "2026-03-07T12:00:00+00:00"),
        ("eval-new-2", "routine-new", "NVDA", "risk-manager", None, None, "review", 0.5, "fresh risk", None, [], [], {}, None, None, "2026-03-07T12:00:01+00:00"),
    ]
    connection = service.storage.connection.return_value.__enter__.return_value
    connection.execute.return_value.fetchall.return_value = rows
    ...
    service._aggregate_symbol_review.assert_called_once()
