    ...
    >
      ...
      <div className="flex flex-wrap gap-6 text-xs text-text-muted">
        <div>
          ...
          <p>
            Positive:{" "}
            <span className="font-medium text-gain">{summary.positiveCount}</span>
          </p>
          <p>
            Neutral:{" "}
            <span className="font-medium text-text">{summary.neutralCount}</span>
          </p>
          <p>
            Negative:{" "}
            <span className="font-medium text-loss">{summary.negativeCount}</span>
          </p>
        </div>
        <div>
