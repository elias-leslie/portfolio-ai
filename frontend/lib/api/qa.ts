 ...
 */
export async function fetchQATrends(days: number = 30): Promise<QATrendsResponse> {
 ...
 * Trigger a QA scan
 */
export async function triggerQAScan(categories?: QACategory[]): Promise<QAScanResponse> {
