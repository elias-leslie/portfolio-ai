  ...
  return (
    <PageContainer className="space-y-10 py-10">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {summaryLoading
                    ? '-'
                    : `$${(summary?.cashBalance || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                </p>
              </div>
              <Wallet
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {summaryLoading
                    ? '-'
                    : `$${(summary?.positionsValue || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                </p>
              </div>
              <PieChart
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {summaryLoading
                    ? '-'
                    : `$${(summary?.totalPortfolioValue || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                </p>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`text-3xl font-bold ${getPnlColor(summary?.totalPnlPct)}`}
                >
                ...
                {!summaryLoading && summary && (
                  ...
                  >
                    {formatCurrency(
                      (summary.totalPortfolioValue || 0) -
                        (summary.startingBalance || 100000),
                    )}
                  </p>
                )}
              </div>
      ...
      <SectionCard variant="surface" padding="none">
        <Tabs
          value={activeTab}
          onValueChange={(val) => setActiveTab(val as 'open' | 'closed')}
        >
          ...
          <TabsContent value="open" className="mt-0">
            {openLoading ? (
              ...
              <div className="p-8 text-center text-text-muted">
                No open positions. AI agents will create trades when
          ...
          <TabsContent value="closed" className="mt-0">
            {closedLoading ? (
              ...
              <div className="p-8 text-center text-text-muted">
                No closed trades yet. Trades will appear here once positions are
                exited.
              </div>
            )}
          </TabsContent>
