"""Private mixin classes for WatchlistRepository.

Each mixin handles a focused concern:
- _WatchlistCoreReadRepository: primary read queries
- _WatchlistReviewReadRepository: review/historical reads
- _WatchlistNewsRepository: news cache queries
- _WatchlistWriteRepository: write / persistence operations
"""
