...
export function ProfileSelector({
  ...
  const [duplicateProfileId, setDuplicateProfileId] = useState<number | null>(
    null,
  )
      ...
      <ProfileSelectorWrapper variant={variant} className={className}>
        ...
        <div className="space-y-2">
          <Select
            ...
            onValueChange={(value) => handleLoad(parseInt(value, 10))}
          >
            <SelectTrigger>
        ...
        <p className="text-xs text-text-muted">
          ...
          store all your preferences including risk tolerance, weights, and
          display settings.
        </p>
      </ProfileSelectorWrapper>
