...
export function SectionCard({
  ...
  const baseClass =
    variant === 'surface'
      ? 'rounded-2xl border border-border/40 bg-surface/50 surface-highlight backdrop-blur-sm transition-[border-color,box-shadow,transform] duration-200 hover:border-border/60 hover:shadow-md glow-border'
      : 'rounded-2xl'
