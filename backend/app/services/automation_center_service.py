        ...
        center = AutomationCenter(
            ...
            guardrails=[
                ...
                AutomationGuardrail(
                    ...
                    enabled=bool(automation["scheduled_strategy_research_enabled"]["enabled"]),
                    source=str(automation["scheduled_strategy_research_enabled"]["source"]),
                    detail="Controls automatic strategy generation and evolution agents that run without opening the app.",
                ),
            ],
