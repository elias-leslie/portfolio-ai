  ...
  const metrics = [
    {
      ...
      usage: `${resources.disk.used_gb.toFixed(1)} GB`,
      total: `${resources.disk.total_gb.toFixed(1)} GB`,
    },
    {
      id: "memory",
      name: "Memory",
      ...
      usage: `${resources.memory.used_gb.toFixed(1)} GB`,
      total: `${resources.memory.total_gb.toFixed(1)} GB`,
    },
    {
      id: "cpu",
      name: "CPU",
    ...
    },
    {
      ...
      usage: `${resources.database_pool.checked_out} active`,
      total: `${resources.database_pool.pool_size} pool`,
