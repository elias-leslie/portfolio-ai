...
const DEMO_PORTFOLIO = {
  ...
  householdTotalValue: DEMO_TOTAL_VALUE,
  householdInvestedTotalValue: round2(DEMO_POSITIONS_VALUE),
  householdCashReserve: DEMO_CASH_TOTAL,
  householdInvestmentAccountsCount: DEMO_ACCOUNTS.length,
  householdTotalsTrusted: true,
  accountControlStatus: 'clear',
  accountControlSummary: 'Demo household totals are internally consistent.',
...
const DEMO_HOUSEHOLD_DASHBOARD: HouseholdFinanceDashboard = {
  ...
  incomeAnchor: {
    ...
    detail: 'Median of May 2026, June 2026 and July 2026.',
    monthlyIncome: 6067,
    source: 'median',
    sourceLabel: 'Median of 3 complete months',
    medianMonthlyIncome: 6067,
    monthsUsed: [
      { month: '2026-05', label: 'May 2026', amount: 6067, isMedian: true },
      { month: '2026-06', label: 'June 2026', amount: 7985, isMedian: false },
      { month: '2026-07', label: 'July 2026', amount: 2804, isMedian: false },
    ],
  ...
  budgetSnapshot: {
    ...
    affordability: {
      ...
      remainingEssentials: 1250,
      essentialsBasis:
        '2,950 of the 4,200 essentials baseline is covered so far in August.',
      committedFunds: 0,
      cardBalances: 4200,
  ...
  retirementContributionTracker: {
    ...
    headline:
      "Today's assets support $4,167/mo against a $6,000/mo plan - a gap of $440,000 in investable assets.",
    detail:
      'That is the distance at today\u2019s balances, with 16 years of growth still to come. $1,750/mo is going in, noted rather than graded.',
    currentAge: 49,
...
const DEMO_ANALYTICS: PortfolioAnalytics = {
  ...
  householdTotalValue: round2(DEMO_TOTAL_VALUE),
  householdInvestedTotalValue: round2(DEMO_POSITIONS_VALUE),
  householdCashReserve: DEMO_CASH_TOTAL,
  householdInvestmentAccountsCount: DEMO_ACCOUNTS.length,
  householdTotalsTrusted: true,
