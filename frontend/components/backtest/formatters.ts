 ...
 */
export function parseToNumber(value: string | number | null | undefined): number | null {
 ...
 */
export function getValueColorClass(value: number | null | undefined, positive = true): string {
