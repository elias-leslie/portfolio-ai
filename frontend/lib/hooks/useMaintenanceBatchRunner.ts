...
import { triggerMaintenanceTask, type MaintenanceResult } from "@/lib/api/maintenance";
...
export interface UseMaintenanceBatchRunnerReturn {
  runAll: (
    ...
    dryRun: boolean,
    dbTaskApiFunctions: Record<string, (dryRun: boolean) => Promise<MaintenanceResult>>
  ) => Promise<BatchResult[]>;
  isRunning: boolean;
