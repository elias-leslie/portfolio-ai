...
export async function getRecommendations(params?: {
  ...
  if (params?.minStrength !== undefined) searchParams.set("min_strength", params.minStrength.toString());
  if (params?.limit) searchParams.set("limit", params.limit.toString());
  if (params?.signalType) searchParams.set("signal_type", params.signalType);
  if (params?.portfolioSize) searchParams.set("portfolio_size", params.portfolioSize.toString());
  if (params?.positionPct) searchParams.set("position_pct", params.positionPct.toString());
