...
echo "  Start all:   sudo systemctl start portfolio-backend portfolio-celery portfolio-frontend"
echo "  Stop all:    sudo systemctl stop portfolio-backend portfolio-celery portfolio-frontend"
echo "  Status:      sudo systemctl status portfolio-backend portfolio-celery portfolio-frontend"
